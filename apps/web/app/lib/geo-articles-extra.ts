...
export const extraArticles: Record<
  ExtraGeoSlug,
...
> = {
  "close-empty-token-accounts-solana": {
    zh: {
      ...
      description:
        "关闭空 ATA 可退回 rent。Phantom 等钱包内操作需你确认；ChainVigil V0 只做只读提示。",
      assertion:
    ...
    en: {
      ...
      description:
        "Closing empty ATAs returns rent. Confirm in Phantom yourself — ChainVigil V0 is read-only.",
      assertion:
      ...
      faq: [
        [
          "How in Phantom?",
          "Use wallet UI that supports closing empty accounts — never share seed phrases.",
        ],
      ...
      signalTable: [
        {
          signal: "balance = 0",
          severity: "INFO",
          plain: "Candidate to close for rent",
        },
        {
          signal: "balance > 0",
          severity: "BLOCK",
        ...
        {
          signal: "asks for seed phrase",
          severity: "BLOCK",
          plain: "Phishing — leave",
        },
      ],
  ...
  "solana-burn-token-sol-refund": {
    zh: {
      ...
      description:
        "Burn 与 close account 不同：烧币减少供给，退 rent 通常靠关闭空账户。",
      assertion:
    ...
    en: {
      ...
      description:
        "Burn ≠ close account. Rent returns usually come from closing empty accounts.",
      assertion:
      ...
      faq: [
        [
          "Burn then get SOL back?",
          "Usually you still need to close the account — verify in explorer.",
        ],
        [
          "Burn junk memes?",
          "Cleanup hygiene is fine; valuation is out of scope.",
        ],
      ],
      relatedSignals: ["burnInstruction", "closeAccount", "rentReclaimable"],
      signalTable: [
        {
          signal: "burn only",
          severity: "INFO",
          plain: "Supply down — rent not guaranteed",
        },
        {
          signal: "close empty ATA",
          severity: "INFO",
          plain: "Common rent return path",
        },
        {
          signal: "unknown full-access dApp",
          severity: "BLOCK",
          plain: "Phishing risk",
        },
      ],
  ...
  "free-solana-wallet-cleanup": {
    zh: {
      ...
      description:
        "先只读扫描可关账户与粉尘，再在你的钱包确认。默认不垫付 Gas，无 SOL 时无法上链。",
      assertion:
      ...
      faq: [
        [
          "没 SOL 能清理吗？",
          "链上交易需要费用。平台垫付是可关权益，默认关闭。",
        ],
        [
          "会动我的主币吗？",
          "标准 close 空账户不转走你的 SOL 余额（除网络费）。",
        ],
      ],
    ...
    en: {
      ...
      description:
        "Read-only list of closable accounts, then you sign. No gas sponsor by default; zero SOL cannot pay fees.",
      assertion:
      ...
      faq: [
        [
          "Cleanup with 0 SOL?",
          "On-chain needs fees. Gas sponsorship is an optional perk, default off.",
        ],
        [
          "Will it move my SOL?",
          "Standard close of empty accounts does not transfer your balance (except fee).",
        ],
      ],
      relatedSignals: ["readOnlyScan", "closeAccount", "gasRequired"],
      signalTable: [
        {
          signal: "read-only list",
          severity: "INFO",
          plain: "Safe starting point",
        },
        { signal: "asks seed phrase", severity: "BLOCK", plain: "Phishing" },
        {
          signal: "gasless claim with 0 SOL",
          severity: "CAUTION",
          plain: "Only trust labeled gas vouchers",
        },
      ],
  ...
  "solana-metadata-mutable-risk": {
    zh: {
      ...
      description:
        "可变 metadata 允许改名称/图标/URI，仿盘与社工会利用「看起来变官方」。",
      assertion:
      ...
      signalTable: [
        {
          signal: "metadataMutable = true",
          severity: "CAUTION",
          plain: "展示信息可改",
        },
        {
          signal: "updateAuthority 仍在",
          severity: "CAUTION",
          plain: "谁可改元数据",
        },
    ...
    en: {
      ...
      description:
        "Mutable metadata can change name/icon/URI — impostors abuse “looks official” branding.",
      assertion:
      ...
      faq: [
        [
          "Mutable = scam?",
          "No. Many legit projects stay mutable; who holds authority matters.",
        ],
      ...
      signalTable: [
        {
          signal: "metadataMutable = true",
          severity: "CAUTION",
          plain: "Display fields can change",
        },
        {
          signal: "update authority live",
          severity: "CAUTION",
          plain: "Who can rewrite metadata",
        },
        {
          signal: "trust name not mint",
          severity: "BLOCK",
          plain: "Impostor path",
        },
      ],
  ...
  "free-solana-rug-check": {
    zh: {
      ...
      description:
        "好的免费工具：不连钱包也能查、标明 mode/confidence、不承诺稳赚。",
      assertion:
    ...
    en: {
      ...
      description:
        "Good free tools: no wallet required, mode/confidence honesty, no “guaranteed safe” theater.",
      assertion:
      ...
      faq: [
        [
          "Need wallet connect?",
          "Not for CA check. Connect only for future revoke/reclaim.",
        ],
      ...
      signalTable: [
        {
          signal: "no mode label",
          severity: "CAUTION",
          plain: "May hide mock/degraded data",
        },
        {
          signal: "SAFE with no evidence",
          severity: "BLOCK",
          plain: "Not actionable",
        },
        {
          signal: "plain language + signals",
          severity: "INFO",
          plain: "Usable pattern",
        },
      ],
      ctaLabel: "Free CA check",
      ctaHref: "/check",
      secondaryCta: {
        href: "/learn/how-to-check-ca",
        label: "How to check a CA",
      },
    },
  },
  "raydium-lp-lock-check": {
    ...
    en: {
      ...
      description:
        "Unlocked new-pool LP can be pulled. Lock/burn proofs must be verifiable — screenshots are not enough.",
      assertion:
      ...
      signalTable: [
        ...
        {
          signal: "unverifiable lock proof",
          severity: "CAUTION",
          plain: "Treat as unlocked",
        },
        {
          signal: "burned/long lock + verifiable",
          severity: "INFO",
          plain: "Lower pull risk",
        },
      ],
  ...
  "owner-renounced-meaning": {
    zh: {
      ...
      description:
        "Renounce 表示特权地址放弃部分或全部控制，不是「一定安全」徽章。",
      assertion:
    ...
    en: {
      ...
      description:
        "Renounce means some privileges may be given up — not a “safe” badge.",
      assertion:
      ...
      faq: [
        ...
        [
          "Not renounced = scam?",
          "No. Many projects keep powers — you should know.",
        ],
      ],
      relatedSignals: [
        "ownerRenounced",
      ...
      signalTable: [
        {
          signal: "owner renounced",
          severity: "INFO",
          plain: "Some control may be gone",
        },
        {
          signal: "mint/tax still on",
          severity: "CAUTION",
          plain: "Critical powers remain",
        },
        {
          signal: "upgradeable proxy",
          severity: "CAUTION",
          plain: "Logic can still change",
        },
      ],
  ...
  "bsc-hidden-mint-authority": {
    ...
    en: {
      ...
      description:
        "Hidden mint can dilute holders. Check privileges, proxies, and unverified code risk.",
      assertion:
      ...
      signalTable: [
        {
          signal: "mint still enabled",
          severity: "CAUTION",
          plain: "Supply can dilute",
        },
        {
          signal: "unverified contract",
          severity: "CAUTION",
          plain: "Hidden logic hard to audit",
        },
        {
          signal: "upgradeable + privileges",
          severity: "CAUTION",
          plain: "Rules can change later",
        },
      ],
  ...
  "bsc-honeypot-sell-fail": {
    zh: {
      title: "小狐狸卖出失败是貔貅吗？",
      description:
        "卖出失败可能是貔貅，也可能是滑点、税、暂停、Gas 或路由问题。先查 CA。",
      assertion:
        "MetaMask「卖出交易失败」不一定等于貔貅；需结合 canSell、税率、黑名单、流动性与 mode 判断。",
      definition: "钱包失败提示只说明本次交易未成功，根因可能有多种。",
    ...
    en: {
      ...
      description:
        "Sell failure may be honeypot — or slippage, tax, pause, gas, or routing. Scan the CA first.",
      assertion:
      ...
      faq: [
        ...
        [
          "Fix with more gas?",
          "If honeypot/blacklist, more gas will not help.",
        ],
      ],
      relatedSignals: [
        "canSell=false",
      ...
      signalTable: [
        {
          ...
          severity: "BLOCK",
          plain: "Strong honeypot signal",
        },
        {
          signal: "extreme sell tax",
          severity: "BLOCK",
          plain: "Exit nearly worthless",
        },
        {
          signal: "slippage/gas only",
          severity: "INFO",
          plain: "May not be a honeypot",
        },
      ],
  ...
  "check-wallet-compromised": {
    zh: {
      ...
      description:
        "只读体检看异常授权、可疑资产与异常活动迹象；不能替代链上取证。",
      assertion:
      ...
      secondaryCta: { href: "/approvals", label: "授权列表演示" },
    },
    en: {
      title: "How to check if a Web3 wallet is compromised",
      description:
        "Read-only health for risky approvals and suspicious assets — not forensic proof.",
      assertion:
      ...
      signalTable: [
        {
          signal: "unknown infinite allowance",
          severity: "BLOCK",
          plain: "Handle first",
        },
        {
          signal: "weird airdrop token",
          severity: "CAUTION",
          plain: "Do not approve/swap casually",
        },
        {
          signal: "support asks seed",
          severity: "BLOCK",
          plain: "Secondary scam",
        },
      ],
  ...
  "revoke-cash-alternative-bsc": {
    zh: {
      ...
      description:
        "替代工具应：只读发现高危授权 + 明文 revoke 语义 + 不代管私钥。",
      assertion:
    ...
    en: {
      ...
      description:
        "Alternatives should discover risky allowances read-only and keep revoke semantics clear — no key custody.",
      assertion:
      ...
      faq: [
        [
          "Must I use Revoke.cash?",
          "No. Any honest read-only + self-sign flow works.",
        ],
        [
          "Does revoke reduce balances?",
          "Standard revoke does not transfer balances.",
        ],
      ],
      relatedSignals: ["allowance", "spender", "revokeOnly"],
      signalTable: [
        {
          signal: "read-only scan",
          severity: "INFO",
          plain: "Safe discovery stage",
        },
        {
          signal: "signature includes transfer",
          severity: "BLOCK",
          plain: "Stop — may not be revoke",
        },
        {
          signal: "infinite unknown spender",
          severity: "CAUTION",
          plain: "Clean first",
        },
      ],
