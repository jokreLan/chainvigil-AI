...
const articles = {
  honeypot: {
    zh: {
      ...
      description:
        "能买不能卖，或卖出税接近 100%。买币前最需要先排除的一票否决风险。",
      assertion:
        "貔貅盘是指合约或交易路径限制正常卖出，常见表现为 canSell=false、极高卖出税或隐藏黑名单。",
      definition:
      ...
      faq: [
        [
          "貔貅一定等于合约写死不能卖吗？",
          "不一定。也可能是高税、黑名单、暂停交易或流动性异常，结果都是「难退出」。",
        ],
      ...
      signalTable: [
        {
          signal: "canSell = false",
          severity: "BLOCK",
          plain: "无法按正常路径卖出，高度疑似貔貅",
        },
        {
          signal: "honeypotDetected",
          severity: "BLOCK",
          plain: "第三方/仿真判定存在蜜罐特征",
        },
        {
          signal: "sellTaxPercent ≥ 90",
          severity: "BLOCK",
          plain: "卖出税接近抽干，变现接近不可能",
        },
        {
          signal: "ownerCanModifyTax",
          severity: "CAUTION",
          plain: "项目方可随时把税改到极端",
        },
      ],
    ...
    en: {
      ...
      description:
        "You can buy but cannot sell, or sell tax is near 100%. A hard-block risk before buying.",
      assertion:
      ...
      faq: [
        [
          "Does honeypot always mean sell is hard-coded off?",
          "Not always. High tax, blacklist, pause, or broken liquidity can all trap exits.",
        ],
        [
          "Strong chart = safe?",
          "No. Volume can be faked. Check the CA first.",
        ],
      ],
      relatedSignals: [
        "canSell=false",
      ...
      signalTable: [
        {
          signal: "canSell = false",
          severity: "BLOCK",
          plain: "Cannot sell on the normal path — strong honeypot signal",
        },
        {
          signal: "honeypotDetected",
          severity: "BLOCK",
          plain: "Simulation/provider flags honeypot traits",
        },
        {
          signal: "sellTaxPercent ≥ 90",
          severity: "BLOCK",
          plain: "Sell tax near 100% makes exit worthless",
        },
        {
          signal: "ownerCanModifyTax",
          severity: "CAUTION",
          plain: "Owner can raise tax to extreme levels",
        },
      ],
  ...
  "sell-tax": {
    zh: {
      ...
      assertion:
        "卖出税是 token 卖出/转出路径上被合约收取的比例；Owner 可改税时风险会突然升高。",
      definition:
        "卖出税是 token 转出/卖出路径上被合约收取的比例，可能固定也可能被 Owner 修改。",
      risk: "高卖出税会吞噬本金；若 Owner 可改税，风险会突然上升。",
      howToDetect: [
        "查看 buy/sell tax 字段",
        "确认 Owner 是否可改税",
        "小额验证前先读报告 mode/confidence",
        "税异常时停止加仓",
      ],
      faq: [
    ...
    en: {
      ...
      description:
        "The fee taken on sell/transfer. Extreme sell tax can make exits nearly impossible.",
      assertion:
        "Sell tax is the percentage taken on sell/transfer paths — fixed or owner-changeable.",
      definition:
        "Sell tax is the percentage taken on sell/transfer paths — fixed or owner-changeable.",
      risk: "High sell tax burns capital; if owner can change tax, risk can spike suddenly.",
      howToDetect: [
        "Read buy/sell tax fields",
        "Check if owner can modify tax",
        "Respect mode/confidence",
        "Stop adding size on abnormal tax",
      ],
      faq: [
        [
          "Low buy tax + high sell tax?",
          "Common trap pattern. Always check both sides.",
        ],
      ...
      signalTable: [
        {
          signal: "high sellTaxPercent",
          severity: "BLOCK",
          plain: "Exit value near zero",
        },
        {
          signal: "ownerCanModifyTax",
          severity: "CAUTION",
          plain: "Tax can jump to 100%",
        },
        {
          signal: "buyTax ≠ sellTax",
          severity: "CAUTION",
          plain: "Classic bait structure",
        },
      ],
  ...
  "lp-unlocked": {
    ...
    en: {
      ...
      description:
        "If liquidity is unlocked/unburned, the team may pull the pool and break exits.",
      assertion:
        "Unlocked/unburned LP means whoever controls it may pull liquidity and break exits.",
      definition:
        "LP enables swaps. Unlocked/unburned LP can be removed by whoever controls it.",
      risk: "After a pull, exits fail or slip wildly. Hot charts do not prove LP safety.",
      howToDetect: [
        "Check lpLocked / LP value signals",
        "Verify lock proofs on explorers",
        "Treat missing proof as caution",
        "Combine with holder concentration",
      ],
      faq: [
        ["High LP value = safe?", "No. Control and lock status matter more."],
        [
          "Trust lock screenshots?",
          "Screenshots can be faked — need verifiable sources.",
        ],
      ],
      relatedSignals: ["lpLocked=false", "lpValueLow", "lpOwnerConcentrated"],
      signalTable: [
        {
          signal: "lpLocked = false",
          severity: "CAUTION",
          plain: "Liquidity may be removed",
        },
        {
          signal: "low LP value",
          severity: "CAUTION",
          plain: "High slippage / hard exits",
        },
        {
          signal: "concentrated LP control",
          severity: "CAUTION",
          plain: "Few actors control the pool",
        },
      ],
  ...
  "unlimited-approval": {
    zh: {
      ...
      assertion:
        "无限授权让 spender 在额度内可持续转走资产；不用的未知 spender 应优先处理。",
      definition:
        "无限授权指 allowance 极大或 setApprovalForAll，让 spender 可持续转走资产。",
      ...
      secondaryCta: { href: "/approvals", label: "查看授权列表（演示）" },
    },
    en: {
      title: "Why are unlimited approvals dangerous?",
      description:
        "Huge allowances let a compromised or malicious spender drain covered assets.",
      assertion:
        "Unlimited approvals let a spender move assets within allowance — unused unknown spenders first.",
      definition:
        "Unlimited approval means a very large allowance or setApprovalForAll for a spender.",
      risk: "Assets can move without a new signature; unknown long-unused spenders are especially risky.",
      howToDetect: [
        "Wallet health for infinite/high-risk approvals",
        "Verify spenders you actually use",
        "Revoke unused ones in your wallet",
        "V0 never signs or auto-revokes",
      ],
      faq: [
        [
          "Will ChainVigil revoke for me?",
          "No. Read-only tips only — you confirm in-wallet.",
        ],
        [
          "Known DEX approvals safe?",
          "More common, still review amount and recency.",
        ],
      ],
      relatedSignals: [
        "allowance=infinite",
      ...
      signalTable: [
        {
          signal: "allowance = infinite",
          severity: "CAUTION",
          plain: "Large blast radius if spender is bad",
        },
        {
          signal: "unknown spender",
          severity: "BLOCK",
          plain: "Unfamiliar contract holds power",
        },
        {
          signal: "long unused",
          severity: "CAUTION",
          plain: "Stale approvals should be cleaned",
        },
      ],
      ctaLabel: "Run wallet health",
      ctaHref: "/wallet-check",
      secondaryCta: { href: "/approvals", label: "Open approvals (demo)" },
    },
  },
  "fake-usdt": {
    zh: {
      ...
      assertion:
        "仿盘用相似名称诱导转账；唯一可靠身份是官方 CA，不是钱包里显示的名字。",
      definition:
        "仿盘使用相似名称/图标诱导转账或交易，合约地址与官方资产不同。",
      ...
      signalTable: [
        {
          signal: "symbolImpersonation",
          severity: "BLOCK",
          plain: "名称/符号仿冒官方资产",
        },
        {
          signal: "unverifiedContract",
          severity: "CAUTION",
          plain: "源码未验证增加后门风险",
        },
    ...
    en: {
      ...
      description:
        "Names and symbols can be faked. Only the official CA is reliable.",
      assertion:
        "Impostors mimic names; only the official CA is identity — not the wallet display label.",
      definition:
        "Impostors mimic names/icons to lure transfers or trades with a different contract.",
      risk: "Wrong-address transfers are often unrecoverable; fakes may add high tax or sell blocks.",
      howToDetect: [
        "Copy CA from official/trusted sources",
        "Compare on explorers",
        "Treat name similarity as suspicious",
        "Scan CA for privilege/tax signals",
      ],
      faq: [
      ...
      signalTable: [
        {
          signal: "symbolImpersonation",
          severity: "BLOCK",
          plain: "Name/symbol clones an official asset",
        },
        {
          signal: "unverifiedContract",
          severity: "CAUTION",
          plain: "Unverified code raises backdoor risk",
        },
        {
          signal: "newPair",
          severity: "INFO",
          plain: "New pools need extra caution",
        },
      ],
  ...
  blacklist: {
    zh: {
      ...
      signalTable: [
        {
          signal: "blacklistFunction",
          severity: "CAUTION",
          plain: "可针对地址限制交易",
        },
        { signal: "pausable", severity: "CAUTION", plain: "可暂停转账/交易" },
        {
          signal: "owner 未 renounce",
          severity: "INFO",
          plain: "规则仍可能变更",
        },
      ],
    ...
    en: {
      ...
      description:
        "Owner may restrict specific accounts so they cannot sell or transfer.",
      assertion:
        "Blacklist privileges let roles block specific addresses from transfer or trade.",
      definition:
        "A blacklist feature lets privileged roles block addresses from transfer/trade.",
      risk: "Balances can become un-sellable; rules can change while privileges remain.",
      howToDetect: [
        "Check blacklistFunction-style signals",
        "Combine with owner/pause/tax powers",
        "Scan CA before sizing up",
        "Stay cautious until renounce is proven",
      ],
      faq: [
        ["No blacklist = safe?", "No. Tax, LP, and sell-path risks remain."],
        [
          "How to prove renounce?",
          "Need verifiable on-chain evidence, not screenshots.",
        ],
      ],
      relatedSignals: ["blacklistFunction", "pausable", "ownerCanModifyTax"],
      signalTable: [
        {
          signal: "blacklistFunction",
          severity: "CAUTION",
          plain: "Addresses can be blocked",
        },
        {
          signal: "pausable",
          severity: "CAUTION",
          plain: "Transfers/trades can be paused",
        },
        {
          signal: "owner not renounced",
          severity: "INFO",
          plain: "Rules may still change",
        },
      ],
  ...
  "how-to-check-ca": {
    zh: {
      ...
      assertion:
        "CA 是识别 token 的唯一入口；买前应：复制官方 CA → 安检 → 独立复核。",
      definition:
        "CA（Contract Address）是识别 token 合约实例的唯一入口，名称不能当身份。",
    ...
    en: {
      ...
      description:
        "Three steps: get the unique CA → scan → re-verify official + explorer sources.",
      assertion:
        "The CA uniquely identifies a token — copy official CA → scan → re-verify before buy.",
      definition:
        "The CA uniquely identifies a token contract instance. Names are not identity.",
      ...
      faq: [
        [
          "Is a shared report enough?",
          "Reports go stale — re-scan before trading.",
        ],
      ...
      signalTable: [
        {
          signal: "mode = mock",
          severity: "INFO",
          plain: "Demo data — not live proof",
        },
        {
          signal: "low confidence",
          severity: "CAUTION",
          plain: "Thin evidence — do not size up",
        },
        {
          signal: "riskLevel = BLOCK",
          severity: "BLOCK",
          plain: "Do not buy until reasons are clear",
        },
      ],
  ...
  "not-investment-advice": {
      ...
      signalTable: [
        {
          ...
          severity: "INFO",
          plain: "仅表示可见安全信号较少，不是推荐",
        },
        {
          signal: "mode = mock",
          severity: "INFO",
          plain: "演示模式，禁止当真金白银依据",
        },
        {
          signal: "notInvestmentAdvice",
          severity: "INFO",
          plain: "工具边界：不做收益判断",
        },
      ],
    ...
    en: {
      ...
      description:
        "ChainVigil assesses trade-safety risk only — not price, yield, or investment value.",
      assertion:
        "Risk reports describe safety signals and uncertainty — never buy or size advice.",
      definition:
        "Reports describe visible safety signals and uncertainty, not trade advice.",
      risk: "Treating “low risk” as “will pump” is a mistake; mock/degraded results are never a basis to size up.",
      howToDetect: [
        "Always read mode/confidence",
        "Use reports as checklists, not tips",
        "Multi-source verify before size",
        "Avoid unknown privileges/tax",
      ],
      faq: [
      ...
      signalTable: [
        {
          signal: "riskLevel = LOW",
          severity: "INFO",
          plain: "Fewer visible hazards — not a tip",
        },
        {
          signal: "mode = mock",
          severity: "INFO",
          plain: "Demo mode — never size on it",
        },
        {
          signal: "notInvestmentAdvice",
          severity: "INFO",
          plain: "Tool boundary: no yield judgment",
        },
      ],
  ...
  "how-to-reclaim-solana-rent": {
    zh: {
      ...
      description:
        "空账户与无用 token 账户会占用 rent；理解回收原理，再使用清理工具（V0 只读演示）。",
      assertion:
      ...
      faq: [
        [
          "会自动帮我退 SOL 吗？",
          "不会。V0 只做只读提示与教育；执行须你签名。",
        ],
        [
          "和貔貅安检有什么关系？",
          "安检防买错；租金回收是持仓卫生，两者都服务「少亏冤枉钱」。",
        ],
      ],
      relatedSignals: [
        "emptyTokenAccount",
    ...
    en: {
      ...
      description:
        "Empty/unused token accounts hold rent. Learn reclaim basics before cleanup tools (V0 read-only demo).",
      assertion:
      ...
      faq: [
        [
          "Will you auto-return SOL?",
          "No. V0 is read-only education; you sign.",
        ],
        [
          "Relation to honeypot checks?",
          "CA checks stop bad buys; rent reclaim is portfolio hygiene.",
        ],
      ],
      relatedSignals: [
        "emptyTokenAccount",
      ...
      signalTable: [
        {
          signal: "empty ATA",
          severity: "INFO",
          plain: "Candidate to close for rent return",
        },
        {
          signal: "balance > 0",
          severity: "BLOCK",
          plain: "Do not close as empty",
        },
        {
          signal: "mode = mock",
          severity: "INFO",
          plain: "Demo list — not a live guarantee",
        },
      ],
  ...
  "is-it-safe-to-revoke-approvals": {
    zh: {
      ...
      description:
        "正确的 revoke 只把 allowance 设为 0，不转走资产；仍须核对 spender 与 Gas。",
      assertion:
      ...
      signalTable: [
        {
          signal: "仅改 allowance→0",
          severity: "INFO",
          plain: "正常 revoke 语义",
        },
        {
          signal: "出现 transfer/swap 字段",
          severity: "BLOCK",
          plain: "可能不是真撤销，停止签名",
        },
        {
          signal: "无限授权未处理",
          severity: "CAUTION",
          plain: "优先处理未知 spender",
        },
      ],
      ctaLabel: "钱包体检",
      ctaHref: "/wallet-check",
      secondaryCta: { href: "/approvals", label: "授权清理演示" },
    },
    en: {
      title: "Is it safe to revoke approvals?",
      description:
        "A proper revoke sets allowance to 0 and does not transfer assets — still verify spender and gas.",
      assertion:
      ...
      definition:
        "Revoke is an on-chain tx that sets allowance to 0 (or turns off setApprovalForAll) for a spender.",
      ...
      faq: [
        [
          "Does revoke move my tokens?",
          "Standard revoke does not. Stop if you see unexpected transfer fields.",
        ],
        [
          "Who pays gas?",
          "You pay network fees unless a labeled promo says otherwise.",
        ],
      ],
      relatedSignals: ["revokeOnly", "noTransfer", "gasNetworkFee"],
      signalTable: [
        {
          signal: "allowance → 0 only",
          severity: "INFO",
          plain: "Normal revoke semantics",
        },
        {
          signal: "unexpected transfer fields",
          severity: "BLOCK",
          plain: "Stop — may not be a real revoke",
        },
        {
          signal: "unused infinite allowance",
          severity: "CAUTION",
          plain: "Prioritize unknown spenders",
        },
      ],
      ctaLabel: "Wallet health",
      ctaHref: "/wallet-check",
      secondaryCta: { href: "/approvals", label: "Approvals demo" },
    },
  },
  "pump-fun-dev-dump-check": {
    zh: {
      ...
      description:
        "meme 发射盘常见：集中持仓、可铸权限、捆绑卖出。先查 CA 与持仓结构，再谈热度。",
      assertion:
    ...
    en: {
      ...
      description:
        "Launch memes often have concentrated holdings, mint powers, and bundled sells. Check CA structure before hype.",
      assertion:
      ...
      faq: [
        [
          "On a leaderboard = safe?",
          "No. Boards are educational/delayed — always re-scan the CA.",
        ],
        [
          "Trust AI summaries?",
          "Prefer verifiable evidence plus mode/confidence.",
        ],
      ],
      relatedSignals: [
        "holderConcentration",
      ...
      signalTable: [
        {
          signal: "extreme concentration",
          severity: "CAUTION",
          plain: "Few wallets can dump",
        },
        {
          signal: "mint/freeze still on",
          severity: "CAUTION",
          plain: "Supply/rules may change",
        },
        {
          signal: "canSell issues",
          severity: "BLOCK",
          plain: "Exit path broken",
        },
        {
          signal: "fresh deploy",
          severity: "INFO",
          plain: "Thin history — higher uncertainty",
        },
      ],
...
export function getGeoArticle(slug: string, locale: Locale): GeoArticle | null {
  ...
  return {
    ...
    sources: isSolana
      ? [
          {
            name: "Solana RPC documentation",
            url: "https://solana.com/docs/rpc",
          },
          {
            name: "Solana token documentation",
      ...
      : [
          ...
          {
            name: "Honeypot.is IsHoneypot API",
    ...
    "@graph": [
      {
        ...
        author: {
          "@type": "Organization",
          name: article.reviewedBy ?? "ChainVigil",
